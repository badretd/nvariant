...
export default function Home() {
  ...
  <section className="home-fragment"><div><span className="eyebrow">Из выпуска</span><h2>Сюжет, который выбирал зритель.</h2><p>У «Выжить в школе» было несколько развилок. Откройте варианты и сравните их с основной линией.</p><Link href="/materials/serial-na-dvoih">Читать «Сериал на двоих» →</Link></div><PlotTree compact /></section>
